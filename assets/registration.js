...
var submitReadyChild = false;
        ...
        function addChildForms(){
            var myform = "<div class='child' id='ch" + childCount + "'>" +
                ...
                "<input type='radio' class='ageRange' name='" + childCount + "[ageRange]' id='" + childCount + "[ageRange6]' value='N/A'><font class='label ageRange' id='Label" + childCount + "[ageRange6]'>Prefer not to say</font><br><br><br>"+ 
                "</div>";
