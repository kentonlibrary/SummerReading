...
<head>
  ...
  <title>Awards <?php echo $branch; ?></title>
...
<body>
  ...
  <div class="main">
    <h3><a href="stats/index.php" target="_blank">Statistics</a></h3>
		<h3><a href="raffleTicket2.php" target="_blank">Blank Ticket</a></h3>
		<h3><a href="stats/lookup.php" target="_blank">Lookup</a></h3>
...
function loadDoc() { //loads complete.php into awards div
  ...
  xhttp.open("GET", "complete.php?cardNumber=" + cardNumber + "&branch=<?php echo $branch; ?>", true);
  xhttp.send();
  $('#cardNumber').select();
}
