...
<body>
  ...
  IFNULL((
    SELECT 
      COUNT(r2rL.bookTitle) AS totalBooks 
    FROM 
      r2rLog 
      r2rL 
    WHERE 
  ...
  IFNULL((
    ...
    IFNULL((
      SELECT 
        SUM(r2rA.booksAwarded) AS picture 
      FROM 
        r2rAward r2rA 
      WHERE 
        r2rA.readerID = r1.readerID 
    ...
    IFNULL((
      SELECT 
        SUM(r2rA.booksAwarded) AS easyReader 
      FROM 
          r2rAward 
          r2rA 
      WHERE 
      ...
      IFNULL((
        SELECT 
          SUM(r2rA.booksAwarded) AS teacher 
        FROM 
          r2rAward 
          r2rA 
        WHERE 
